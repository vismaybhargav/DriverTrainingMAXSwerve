...
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module) {
        ...
        driveSpark = new SparkMax(
                switch (module) {
                    case 0 -> FRONT_LEFT_DRIVING_CAN_ID;
                    case 1 -> FRONT_RIGHT_DRIVING_CAN_ID;
                    case 2 -> REAR_LEFT_DRIVING_CAN_ID;
                    case 3 -> REAR_RIGHT_DRIVING_CAN_ID;
                    default -> 0;
                },
                MotorType.kBrushless);
        turnSpark = new SparkMax(
                switch (module) {
                    case 0 -> FRONT_LEFT_TURNING_CAN_ID;
                    case 1 -> FRONT_RIGHT_TURNING_CAN_ID;
                    case 2 -> REAR_LEFT_TURNING_CAN_ID;
                    case 3 -> REAR_RIGHT_TURNING_CAN_ID;
                    default -> 0;
                },
                MotorType.kBrushless);
        ...
        driveConfig
                ...
                .smartCurrentLimit((int)DRIVING_CURRENT_LIMIT)
        ...
        turnConfig
                ...
                .idleMode(IdleMode.kBrake)
                .smartCurrentLimit((int)TURNING_CURRENT_LIMIT)
                .voltageCompensation(12.0);
        turnConfig
                .absoluteEncoder
